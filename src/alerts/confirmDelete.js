...
import { deleteSensor, deleteSensorState } from '../slices/ContactSlice';
import { red } from '../colors/color';
...
const AlertDelete = ({contact, isDark}) => {
    ...
    return (
        <div>
            <IconButton onClick={() => {
                handleClickOpen();
            }} sx={{ backgroundColor: isDark ? red: "#ff9800", width: { xs: 180, sm: 40 }, height: 40, borderRadius: 2, mt: 1.8, }} aria-label="delete">
                <Delete />
            </IconButton>
            <Dialog
                open={open}
            ...
            >
                ...
                <DialogActions sx={{ margin: "0 auto", mb: 3 }}>
                    ...
                    <Button
                        onClick={() => {
                            dispatch(deleteSensorState(contact.id));
                            dispatch(deleteSensor(contact.id));
                            handleClose();
                        }}
                        autoFocus
